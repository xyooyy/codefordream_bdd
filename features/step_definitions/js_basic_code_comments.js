...
var Steps = function () {
    ...
    Given(/^我在注释符号练习页面$/,function(callback){
    ...
    When(/^输入正确答案并提交$/,function(callback){
        this.spooky.then(function () {
    ...
    Then(/^挑战成功$/, function (callback) {
        this.spooky.then(function () {
            ...
            var casper = this;
            this.wait(4000,function(){
                this.test.begin("code comments challenge succeed", 1, function (test) {
